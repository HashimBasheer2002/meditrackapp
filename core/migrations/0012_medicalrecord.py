...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0011_appointment_is_new_patient_alter_appointment_status_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_records', to='core.appointment')),
